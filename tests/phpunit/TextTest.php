...
class TextTest extends TestCase {
    ...
    public static function dataBB(): array {
        ...
        return [
            ...
            ["text-quote-tid",  "[quote=phpunit|t123]a[/quote]", "<a href=\"#\" onclick=\"QuoteJump(event, 't123'); return false;\"><strong class=\"quoteheader\">phpunit</strong> wrote: </a><blockquote>a</blockquote>"],
            ["text-quote-fid",  "[quote=phpunit|123]a[/quote]",  "<a href=\"#\" onclick=\"QuoteJump(event, '123'); return false;\"><strong class=\"quoteheader\">phpunit</strong> wrote: </a><blockquote>a</blockquote>"],
            ["text-quote-bork", "[quote=phpunit|]a[/quote]",     "<strong class=\"quoteheader\">phpunit</strong> wrote: <blockquote>a</blockquote>"],
